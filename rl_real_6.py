...
def run_experiment(seed, episodes=15, steps_per_episode=16):
    random.seed(seed)
...
def main():
    print("Starting REAL 6-deep-target libFuzzer experiment (5 seeds, 15 episodes)...")
    ...
    for s in seeds:
        ...
        rr, rlr = run_experiment(s, episodes=episodes, steps_per_episode=16)
        all_rand.append(rr)
        all_rl.append(rlr)
